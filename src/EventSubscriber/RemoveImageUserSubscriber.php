...
class RemoveImageUserSubscriber implements EventSubscriberInterface
{
    /**
     * @var KernelInterface
     */
    ...
    public function deleteImage(ViewEvent $event){
        ...
        if(!$entity instanceof Users || !in_array($method,[Request::METHOD_DELETE])){
            return;
        }
        $url = $entity->getProfilePic()->getUrl();
